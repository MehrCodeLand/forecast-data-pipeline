...
const I18N = {
    en: {
        ...
        compare_no_data: 'No data could be loaded for the selected cities. Please try again.',
        retry: 'Try again',
        metric: 'Metric',
    ...
    fa: {
        ...
        compare_no_data: 'برای شهرهای انتخاب‌شده داده‌ای دریافت نشد. لطفاً دوباره تلاش کنید.',
        retry: 'تلاش دوباره',
        metric: 'شاخص',
